...
1. Get the [latest rust](https://rust-lang.org/tools/install/) or run `rustup update` if you already have Rust installed.
2. Clone [xous-core](https://github.com/betrusted-io/xous-core).
...
See [Getting Started with Baochip Targets](https://github.com/betrusted-io/xous-core/blob/main/README-baochip.md).
